...
function mytheme_custom_styles() {
    ...
    wp_enqueue_style( 'custom-style1', get_template_directory_uri() . '/css/vendors/bootstrap.min.css' );
	wp_enqueue_style( 'custom-style2', get_template_directory_uri() . '/css/vendors/animate.css' );
	wp_enqueue_style( 'custom-style3', get_template_directory_uri() . '/css/vendors/swiper-bundle.min.css' );
	
	wp_enqueue_style( 'custom-style4', get_template_directory_uri() . '/css/vendors/flaticon/flaticon.css' );
	wp_enqueue_style( 'custom-style5', get_template_directory_uri() . '/css/vendors/all.min.css' );
	wp_enqueue_style( 'custom-style6', get_template_directory_uri() . '/css/vendors/bootstrap-icons-1.9.1/bootstrap-icons.css' );

    wp_enqueue_style( 'custom-style7', get_template_directory_uri() . '/css/vendors/jquery.fancybox.min.css' );
  
        wp_enqueue_style( 'custom-style9', get_template_directory_uri() . '/css/main-LTR.css' );
}
...
wp_enqueue_script( 'myscript1', get_template_directory_uri() . '/js/vendors/jquery-3.6.1.min.js', array(), false, true );
wp_enqueue_script( 'myscript2', get_template_directory_uri() . '/js/vendors/appear.min.js', array(), false, true );
wp_enqueue_script( 'myscript3', get_template_directory_uri() . '/js/vendors/bootstrap.bundle.min.js', array(), false, true );
wp_enqueue_script( 'myscript4', get_template_directory_uri() . '/js/vendors/jquery.countTo.js', array(), false, true );	
wp_enqueue_script( 'myscript5', get_template_directory_uri() . '/js/vendors/wow.min.js', array(), false, true );	
wp_enqueue_script( 'myscript6', get_template_directory_uri() . '/js/vendors/swiper-bundle.min.js', array(), false, true );	
wp_enqueue_script( 'myscript7', get_template_directory_uri() . '/js/vendors/particles.min.js', array(), false, true );  
wp_enqueue_script( 'myscript8', get_template_directory_uri() . '/js/vendors/vanilla-tilt.min.js', array(), false, true ); 
wp_enqueue_script( 'myscript9', get_template_directory_uri() . '/js/vendors/isotope-min.js', array(), false, true ); 
wp_enqueue_script( 'myscript10', get_template_directory_uri() . '/js/vendors/jquery.fancybox.min.js', array(), false, true ); 
wp_enqueue_script( 'myscript11', get_template_directory_uri() . '/js/main.js', array(), false, true ); 
...
function add_extra_class_to_menu_items($classes, $item, $args, $depth) {
    ...
    if (in_array('menu-item-has-children', $classes)) {
        $classes[] = 'has-sub-menu'; // Add your custom class
    }
    return $classes;
}
...
class Custom_Walker_Nav_Menu extends Walker_Nav_Menu {
    ...
    function start_el(&$output, $item, $depth = 0, $args = null, $id = 0) {
        ...
        $atts['class'] = 'menu-link' . $active_class;
        ...
        // Add Plus Icon for Dropdowns
        if ($args->walker->has_children) {
            $item_output .= ' <i class="fas fa-plus plus-icon"></i>';
        }
