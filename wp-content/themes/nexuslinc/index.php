...
<?php  $lang=get_bloginfo("language"); ?>
 ...
 <section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
      ...
      <div class="container">
          ...
          <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s"> <?php if($lang=='th'){ echo 'บล็อกน';}else{ echo 'blog'; }?></h1> 
          <nav aria-label="breadcrumb ">
            <ul class="breadcrumb wow fadeInUp" data-wow-delay=".6s">
              ...
              <li class="breadcrumb-item active"> <?php if($lang=='th'){ echo 'บล็อก';}else{ echo 'Blog'; }?></li>
            </ul>
          </nav>
        </div>
      </div>
